...
export const newservice = {
  ...
  details: {
    ...
    mapPlaceholder: "Type a neighborhood or private street in Tijuana",
    locationApproxNote:
  ...
  errors: {
    ...
    locationOutsideTijuana: "That location is outside Tijuana. We only accept services within the city for now.",
